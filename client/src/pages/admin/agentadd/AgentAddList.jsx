...
export default function AgentAddList() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-200 to-slate-300 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 sm:p-6">
      <Card className="border-slate-200 dark:border-gray-700 shadow-lg dark:shadow-black/30 rounded-2xl w-full max-w-6xl mb-auto md:mb-0 bg-white dark:bg-gray-900">
        <CardHeader>
          ...
          <div className="overflow-x-auto">
            <table className="w-full max-w-xl mx-auto items-center border-collapse text-sm">
              <thead className="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                <tr>
                  <th className="px-2 py-3 text-start text-gray-700 dark:text-gray-300 font-medium">
                    Name
                  </th>
